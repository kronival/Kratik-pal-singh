    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        {(isAdmin || user?.role === 'ACCOUNTANT') && (
          <button onClick={openNew} className="bg-blue-600 text-white px-4 py-2 rounded-lg flex items-center gap-2 hover:bg-blue-700 transition-colors shadow-sm dark:bg-blue-500 dark:hover:bg-blue-600">
      ...
      <div className="bg-white dark:bg-slate-800 p-4 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 flex flex-col md:flex-row gap-4 transition-colors">
        ...
        <div className="flex items-center gap-2">
          <Filter className="text-slate-400 dark:text-gray-500" size={18} />
          <select 
            className="border border-slate-200 dark:border-slate-600 rounded-lg px-3 py-2 outline-none bg-white dark:bg-slate-800 text-slate-900 dark:text-white"
            value={classFilter}
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-700">
              {filteredStudents.map(s => {
                ...
                return (
                  ...
                  >
                    <td className="px-6 py-4 font-medium text-slate-900 dark:text-white">{s.admissionNumber}</td>
